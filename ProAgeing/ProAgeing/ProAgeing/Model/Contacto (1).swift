...
class Contacto: NSObject, NSCoding {
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(self.isFavorite, forKey:"isFavorite_Con")
        aCoder.encode(self.lastCalled, forKey:"lastCalled_Con")
        print("ENCONDING \(self.name) LASTCALLED = \(self.lastCalled.description)")
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.isFavorite = aDecoder.decodeObject(forKey: "isFavorite_Con") as? Bool ?? false
        
        print("USER SAVED \(aDecoder.decodeObject(forKey: "lastCalled_Con")) NAME \(aDecoder.decodeObject(forKey: "name_Con"))")
       //d self.lastCalled = aDecoder.decodeObject(forKey: "lastCalled_Con") as! Bool
        
        print("CONTACTO isFavorite \(self.name) \(self.isFavorite)")
